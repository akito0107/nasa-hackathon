...
class StarsControllerTest < ActionController::TestCase
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post :create, star: { description: @star.description, lat: @star.lat, lon: @star.lon, name: @star.name }
    end
  ...
  test "should update star" do
    patch :update, id: @star, star: { description: @star.description, lat: @star.lat, lon: @star.lon, name: @star.name }
    assert_redirected_to star_path(assigns(:star))
  end
